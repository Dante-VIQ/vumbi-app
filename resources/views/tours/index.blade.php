            ...
            <aside x-data="{ open: false }" class="lg:col-span-1">
                <div class="lg:sticky lg:top-6 space-y-4">
                    ...
                    <button @click="open = !open"
                        ...
                        :aria-expanded="open">
                        Filters
                        <svg :class="open ? 'rotate-180' : ''" class="w-5 h-5 transform transition-transform" fill="none"
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        x-transition:leave-end="opacity-0 -translate-y-2" class="lg:block space-y-4" x-cloak>
                            ...
                            <div class="w-full">
                                ...
                                <select name="type" form="filter-form"
                                    ...
                                    @foreach ($types as $type)
                                        <option value="{{ $type }}"
                                            {{ request('type') == $type ? 'selected' : '' }}>{{ ucfirst($type) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <select name="difficulty" form="filter-form"
                                    ...
                                    @foreach ($difficulties as $diff)
                                        <option value="{{ $diff }}"
                                            {{ request('difficulty') == $diff ? 'selected' : '' }}>{{ ucfirst($diff) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
