...
@section('title', $blog->title . ' - Field Notes | Vumbi Ventures')
@section('description', $blog->excerpt ?? strip_tags(substr($blog->content, 0, 160)))
@section('keywords', $blog->tags ?? 'Field Notes, Vumbi Ventures, African stories, overlooked places')
