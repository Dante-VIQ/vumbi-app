...
new class extends Component {
    ...
    {
        // Guaranteed non-null due to route model binding
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | 2. Affiliate Matching Engine (Monetization Layer)
        |--------------------------------------------------------------------------
        */
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | 4. Static Affiliate Programs (Fallback/Backup)
        |--------------------------------------------------------------------------
        */
    ...
    {
        $rawContent = $this->blog->description ?? $this->blog->content ?? '';
