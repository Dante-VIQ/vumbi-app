<?php
// resources/views/livewire/booking-modal.blade.php
...
new class extends Component {
    ...
    public function submit()
    {
        ...
        $data = $this->form->all();
        $data['partner_package_id'] = $this->partner_package->id;
...
<div class="max-w-2xl mx-auto p-6 bg-zinc-950 rounded-3xl border border-zinc-800 my-20">
    @if($submitted)
        <div class="text-center">
            ...
            <p class="text-zinc-300 mt-4">
                We've received your request for <strong>{{ $tour->title }}</strong>.
            </p>
    ...
    @else
        <h3 class="text-xl font-semibold mb-1">Book {{ $tour->title }}</h3>
